...
Currently, to install, take the files and place them into your game directory FinalFantasyXI/ROM/0 either overwriting the default ones or you can use the Tex Hammer program to edit them into your existing .DAT backgrounds.
